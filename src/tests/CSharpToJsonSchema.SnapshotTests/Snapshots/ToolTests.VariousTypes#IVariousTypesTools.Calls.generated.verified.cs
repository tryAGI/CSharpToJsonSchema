...
namespace CSharpToJsonSchema.IntegrationTests
{
    ...
    public class GetValueAsync2Args
    {
         
         
    }

    public class GetValueAsync3Args
    {
    ...
    public static partial class VariousTypesToolsExtensions
    {
        public static global::System.Collections.Generic.IReadOnlyDictionary<string, global::System.Func<string, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<string>>> AsCalls(this IVariousTypesTools service)
        {
            return new global::System.Collections.Generic.Dictionary<string, global::System.Func<string, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<string>>>
            {
                ...
                ["GetValueAsync2"] = async (json, cancellationToken) =>
                {
                    return await service.CallGetValueAsync2(json, cancellationToken);
                },

                ["GetValueAsync3"] = async (json, cancellationToken) =>
                {
                    return await service.CallGetValueAsync3(json, cancellationToken);
                },
        ...
        #pragma warning disable IL2026, IL3050
        public static GetValueAsync2Args AsGetValueAsync2Args(
            this IVariousTypesTools functions,
            string json)
        {
            #if NET6_0_OR_GREATER
            if(global::System.Text.Json.JsonSerializer.IsReflectionEnabledByDefault)
            {
                ...
                return global::System.Text.Json.JsonSerializer.Deserialize<GetValueAsync2Args>(json, new global::System.Text.Json.JsonSerializerOptions
                {
                    PropertyNamingPolicy = global::System.Text.Json.JsonNamingPolicy.CamelCase,
                    Converters = {{ new global::System.Text.Json.Serialization.JsonStringEnumConverter(global::System.Text.Json.JsonNamingPolicy.CamelCase) }}
                }) ??
            ...
            {
                return global::System.Text.Json.JsonSerializer.Deserialize(json, global::CSharpToJsonSchema.IntegrationTests.VariousTypesToolsExtensionsJsonSerializerContext.Default.GetValueAsync2Args) ??
                throw new global::System.InvalidOperationException("Could not deserialize JSON.");
            }
            #else
            return
                global::System.Text.Json.JsonSerializer.Deserialize<GetValueAsync2Args>(json, new global::System.Text.Json.JsonSerializerOptions
                {
                    PropertyNamingPolicy = global::System.Text.Json.JsonNamingPolicy.CamelCase,
                    Converters = {{ new global::System.Text.Json.Serialization.JsonStringEnumConverter(global::System.Text.Json.JsonNamingPolicy.CamelCase) }}
                }) ??
        ...
        #pragma warning disable IL2026, IL3050
        public static GetValueAsync3Args AsGetValueAsync3Args(
            this IVariousTypesTools functions,
            string json)
        {
            #if NET6_0_OR_GREATER
            if(global::System.Text.Json.JsonSerializer.IsReflectionEnabledByDefault)
            {
                ...
                return global::System.Text.Json.JsonSerializer.Deserialize<GetValueAsync3Args>(json, new global::System.Text.Json.JsonSerializerOptions
                {
                    PropertyNamingPolicy = global::System.Text.Json.JsonNamingPolicy.CamelCase,
                    Converters = {{ new global::System.Text.Json.Serialization.JsonStringEnumConverter(global::System.Text.Json.JsonNamingPolicy.CamelCase) }}
                }) ??
            ...
            {
                return global::System.Text.Json.JsonSerializer.Deserialize(json, global::CSharpToJsonSchema.IntegrationTests.VariousTypesToolsExtensionsJsonSerializerContext.Default.GetValueAsync3Args) ??
                throw new global::System.InvalidOperationException("Could not deserialize JSON.");
            }
            #else
            return
                global::System.Text.Json.JsonSerializer.Deserialize<GetValueAsync3Args>(json, new global::System.Text.Json.JsonSerializerOptions
                {
                    PropertyNamingPolicy = global::System.Text.Json.JsonNamingPolicy.CamelCase,
                    Converters = {{ new global::System.Text.Json.Serialization.JsonStringEnumConverter(global::System.Text.Json.JsonNamingPolicy.CamelCase) }}
                }) ??
        ...
        public static string CallGetCurrentWeather3(this IVariousTypesTools functions, string json)
        {
            ...
            {
                var jsonTypeInfo = global::CSharpToJsonSchema.IntegrationTests.VariousTypesToolsExtensionsJsonSerializerContext.Default.GetTypeInfo(jsonResult.GetType()) ??
        ...
        #pragma warning disable IL2026, IL3050
        public static async global::System.Threading.Tasks.Task<string> CallGetValueAsync2(
            this IVariousTypesTools functions,
            string json,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var args = functions.AsGetValueAsync2Args(json);
            var jsonResult = await functions.GetValueAsync2(cancellationToken);
        ...
        #pragma warning disable IL2026, IL3050
        public static async global::System.Threading.Tasks.Task<string> CallGetValueAsync3(
            this IVariousTypesTools functions,
            string json,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var args = functions.AsGetValueAsync3Args(json);
            var jsonResult = await functions.GetValueAsync3(cancellationToken);
