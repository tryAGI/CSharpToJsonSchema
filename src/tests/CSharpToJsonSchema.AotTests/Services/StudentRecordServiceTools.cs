...
public class StudenRecordService : IStudenRecordService
{
...
[GenerateJsonSchema()]
public interface IStudenRecordService
{
    [Description("Get student record for the year")]
    public Task<StudentRecord> GetStudentRecordAsync([Description("Request to query student records")]QueryStudentRecordRequest query,
        CancellationToken cancellationToken = default);
}
