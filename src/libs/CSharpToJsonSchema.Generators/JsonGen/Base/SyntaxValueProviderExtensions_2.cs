...
using Aliases = CSharpToJsonSchema.Generators.JsonGen.Base.ValueListBuilder<(string aliasName, string symbolName)>;
...
internal static partial class SyntaxValueProviderExtensions
{
        ...
        Func<SyntaxNode, CancellationToken, bool> predicate)
    {
            ...
            SyntaxNode compilationUnit)
        {
            ...
            return GlobalAliases.Create(CSharpToJsonSchema.Generators.JsonGen.Helpers.RoslynExtensions2.ToImmutableArray(globalAliases.AsSpan()));
        }
    }
